...
export default function AdBudget() {
  ...
  const handleSelection = (budget: string) => {
    saveFunnelData('adBudget', budget);
    router.push('/grow/urgency');
  };
  ...
  const budgetRanges = [
    { icon: "💵", text: "Under $5K/month" },
    { icon: "💬", text: "$5K-$10K/month" },
    { icon: "🍊", text: "$10K-$20K/month" },
    { icon: "⭐", text: "$20K-$100K/month" },
    { icon: "👀", text: "$100K+/month" },
  ];
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-6 md:px-4 md:py-8">
        <div className={`w-full max-w-3xl transition-all duration-1000 ${
          ...
          <h1 className={`text-lg md:text-2xl text-center mb-6 md:mb-8 font-bold leading-tight max-w-3xl mx-auto transition-colors ${
            ...
            What's your monthly budget for creator advertising?
          </h1>
