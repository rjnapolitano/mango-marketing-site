...
export default function FunnelStatus() {
  ...
  const handleSelection = (status: string) => {
    saveFunnelData('funnelStatus', status);
    router.push('/grow/ad-budget');
  };
  ...
  const funnelOptions = [
    { icon: "🔽", text: "Yes, but we're not getting good results" },
    { icon: "🔍", text: "No, we haven't tried it yet" },
    { icon: "✨", text: "We tried it but gave up" },
  ];
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-6 md:px-4 md:py-8">
        <div className={`w-full max-w-4xl transition-all duration-1000 ${
          ...
          <h1 className={`text-lg md:text-2xl text-center mb-6 md:mb-8 font-bold leading-tight max-w-3xl mx-auto transition-colors ${
            ...
            Do you work with influencers right now?
          </h1>
