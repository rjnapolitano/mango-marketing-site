...
export default function Urgency() {
  ...
  const handleSelection = (urgency: string) => {
    saveFunnelData('urgency', urgency);
    router.push('/grow/strategy-session');
  };
  ...
  const urgencyOptions = [
    { icon: "⚡", text: "Yes — we're ready to move fast" },
    { icon: "💬", text: "Open to it if the right fit" },
    { icon: "🔍", text: "Just exploring options" },
  ];
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-6 md:px-4 md:py-8">
        <div className={`w-full max-w-3xl transition-all duration-1000 ${
          ...
          <h1 className={`text-lg md:text-2xl text-center mb-6 md:mb-8 font-bold leading-tight max-w-3xl mx-auto transition-colors ${
            ...
            Are you actively looking for help right now?
          </h1>
          ...
          <div className="flex flex-col gap-2 md:gap-3 max-w-2xl mx-auto">
            {urgencyOptions.map((option, index) => (
              ...
              >
                <span className="text-xl md:text-2xl flex-shrink-0">{option.icon}</span>
